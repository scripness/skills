...
| Spec | Code | Purpose |
|------|------|---------|
| [`[domain].md`](./[domain].md) | `[path or area]` | [what it defines] |

## Architecture And Shared Systems

| Spec | Code | Purpose |
|------|------|---------|
| [`[architecture].md`](./[architecture].md) | `[path or area]` | [what it defines] |

## Quality And Operations

| Spec | Code | Purpose |
|------|------|---------|
| [`[testing-strategy].md`](./[testing-strategy].md) | `[path or area]` | [what it defines] |
